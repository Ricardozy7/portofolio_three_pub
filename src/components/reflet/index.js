...
import TriangleSvg from '../../assets/imgs/triangle.svg'
import Surface from '../../assets/imgs/SurfaceImperfections003_1K_Normal.jpg';
import Surface2 from '../../assets/imgs/SurfaceImperfections003_1K_var1.jpg';
...
function Triangle({ color, ...props }) {
  ...
  const { paths: [path] } = useLoader(SVGLoader, TriangleSvg) // prettier-ignore
...
function Ground(props) {
  const [floor, normal] = useTexture([Surface2, Surface])
  return (
  ...
  return (
    <Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 0]}}>
      ...
      <Suspense fallback={null}>
        <Rig>
          <Triangle color="#8400e1" scale={0.009} position={[0, 0, -2]} rotation={[0, 0, Math.PI / 3]} />
          <Triangle color="white" scale={0.009} position={[2, 0, -5]} rotation={[0, 0, Math.PI / 3]} />
          <Triangle color="white" scale={0.009} position={[-2, 0, -5]} rotation={[0, 0, Math.PI / 3]} />
          {/* <Triangle color="#8400e1" scale={0.009} position={[0, 2, -10]} rotation={[0, 0, Math.PI / 3]} /> */}
